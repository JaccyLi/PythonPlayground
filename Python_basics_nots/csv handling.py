import csv
# e1
with open('../test_file/cool_csv.csv', newline='') as cool_csv_file:
...
# e2
isbn_list = []
with open('../test_file/books.csv', newline='') as books_csv:
...
with open('./test_file/logger.csv', 'w') as logger_csv:
